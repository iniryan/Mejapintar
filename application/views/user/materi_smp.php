<section id="home-section" class="hero">
          ...
          <div class="slider-item" style="background-image: url(<?= base_url('assets/img/class.jpg') ?>);">
            ...
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 ftco-animate text-center">
                  ...
                  <h2 class="subheading mb-4">Pelajari Materi SMP</h2>
            ...
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-sm-12 ftco-animate text-center">
                  <h1 class="mb-2"><b>Pelajaran SMP</b></h1>
                  <h2 class="subheading mb-4">Belajar Materi Pelajaran SMP</h2>
    ...
    <section class="ftco-section">
        <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-0 text-uppercase">Materi SMP Mejapintar</h2>
                            ...
                            <div class="tab-outline">
                                ...
                                <div class="tab-content mt-4 " id="myTabContent2">
                                    <div class="tab-pane fade <?= $this->input->post('keyword_math') ? 'show active' : ''; ?>" id="outline-one" role="tabpanel" aria-labelledby="tab-outline-one">
                                        <div class="col-md-12">
                                            <form action="<?= base_url('user/materi_smp') ?>" method="post">
