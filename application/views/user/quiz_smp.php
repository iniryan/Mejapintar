                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Quiz SMP</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<section class="ftco-section">
        <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-0 text-uppercase">Quiz SMP Mejapintar</h2>
        ...
        <div class="row no-gutters ftco-services">
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">   
              ...
              <a href="<?= base_url('user/quiz_begin/'). '32'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '35'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>    
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '38'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '41'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>      
          </div>
