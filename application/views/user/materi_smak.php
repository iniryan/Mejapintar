<section id="home-section" class="hero">
          ...
          <div class="slider-item" style="background-image: url(<?= base_url('assets/img/hands.jpg') ?>);">
            ...
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 ftco-animate text-center">
                  ...
                  <h2 class="subheading mb-4">Pelajari Materi SMA/K</h2>
          ...
          <div class="slider-item" style="background-image: url(<?= base_url('assets/img/aedi4.jpg') ?>);">
            <div class="overlay"></div>
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                <div class="col-sm-12 ftco-animate text-center">
                  <h1 class="mb-2"><b>Pelajaran SMA/K</b></h1>
                  <h2 class="subheading mb-4">Belajar Materi Pelajaran SMA/K</h2>
    ...
    <section class="ftco-section">
        <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-0 text-uppercase">Materi SMA/K Mejapintar</h2>
                                    ...
                                    <div class="tab-pane fade <?= $this->input->post('keyword_math') ? 'show active' : ''; ?>" id="outline-one" role="tabpanel" aria-labelledby="tab-outline-one">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card p-1 mb-3">
                                                <div class="card-header">
                                                        <h5 class="mb-0">
                                                        <?php $sudah_baca = $this->db->get_where('riwayat',['id_user'=>$user['id_user'], 'id_materi'=>$row['id_materi']])->row_array(); if(!isset($sudah_baca)): ?>

                                                            <a href="<?= base_url('user/materi/').$row['nama_mapel'].'/'.$row['id_materi'] ?>" class="btn btn-link">
                                                                <?= $row['judul_bab']?>
                                                            </a>
                                                            ...
                                                            <span class="text-success float-right">Sudah dibaca</span>
