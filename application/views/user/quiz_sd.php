                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Quiz SD</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<section class="ftco-section">
        <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-0 text-uppercase">Quiz SD Mejapintar</h2>
                            ...
                            <div class="tab-outline">
                                ...
                                <div class="tab-content mt-4 " id="myTabContent2">
                                    <div class="tab-pane fade <?= $this->input->post('keyword_math') ? 'show active' : ''; ?>" id="outline-one" role="tabpanel" aria-labelledby="tab-outline-one">
                                        <div class="col-md-12">
                                            <form action="<?= base_url('user/materi_sd') ?>" method="post">
    ...
    <!-- <section class="ftco-section">
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">		
              ...
              <a href="<?= base_url('user/quiz_begin/'). '31'?>" class="btn btn-primary">
                    Mulai
              </a>
              <a href="<?= base_url('user/quiz_list/'). '31'?>" class="btn btn-primary">
                    Daftar
              </a>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '34'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>    
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '37'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <a href="<?= base_url('user/quiz_begin/'). '40'?>" class="btn btn-primary">
                    Mulai
              </a>
            </div>      
          </div>
