                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Comment News</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
          ...
          <!-- end -->
            ...
            <!-- start  -->
                 <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Mejapintar | Comment News</h5>
                                    ...
                                    <table class="table" id="Comment">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($query->result_array() as $row) {
                                                ...
                                                $konten = $this->db->get_where('news', ['id_news' => $row['id_news']])->row_array(); 
                                                ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        <td><?= $row['id_komen']; ?></td>
                                                        ...
                                                        <td><?= $row['date_komen']; ?></td>
                                                        <td>
                                                            <a href="<?= base_url('admin/delete_komen/') . $row['id_komen']; ?>">
                                                                <button onclick="return confirm('Are you sure want to delete this data?')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                                            </a>
                                                        
                                                            <a href="<?= $row['id_komen']; ?>" class="btn btn-info" data-toggle="modal" data-target="#detailComment<?= $row['id_komen']  ?>">
