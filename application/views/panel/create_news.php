<div class="dashboard-wrapper">
        ...
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Create News</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Mejapintar | Create News</h5>
                            <div class="card-body p-0">
                                   
                                   <?= form_open_multipart('admin/create_news'); ?>
                                   ...
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="konten" class="col-sm-12 col-form-label">Konten</label>
                                        <div class="col-lg-10">
                                        <textarea type="text" class="form-control ckeditor" id="ckeditor6" name="konten" rows="25"></textarea>
                                  ...
                                  <div class="form-group row mt-2 ml-3">
                                        <div class="col-lg-12 mt-3">
                                            ...
                                            <a href="<?= base_url('admin/news'); ?>" class="btn btn-light">Cancel</a>
                                        </div>
                                   </div>
                                 <?php form_close() ?>
                            </div>
