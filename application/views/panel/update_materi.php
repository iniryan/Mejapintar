        ...
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Update Materi</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
          ...
          <!-- end -->
            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Mejapintar | Update Materi</h5>
                            <div class="card-body p-0">
                                  <?= form_open_multipart('admin/update_materi'); ?>
                                  <input type="hidden" class="form-control" id="id_materi" name="id_materi" required value="<?= $detail['id_materi']?>">
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="nama_mapel" class="col-sm-12 col-form-label">Nama Mapel</label>
                                        <div class="col-lg-4">
                                          
                                        <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" required value="<?= $detail['nama_mapel']?>">
                                        ...
                                        <div class="form-group row mt-2 ml-3 col-lg-4">
                                            <select name="id_sub" id="id_sub" class="form-control" value="<?=  $detail['sub_kategori']?>">
                                   ...
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="judul_bab" class="col-sm-12 col-form-label">Judul Bab</label>
                                        <div class="col-lg-4">
                                        <input type="text" class="form-control" id="judul_bab" name="judul_bab" value="<?= $detail['judul_bab']?>" required>
                                   ...
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="isi_materi" class="col-sm-12 col-form-label">Isi Materi</label>
                                        <div class="col-lg-10">
                                        <textarea type="text" class="form-control ckeditor" id="ckeditor" name="isi_materi" rows="25" required><?= $detail['isi_materi']?></textarea>
                                   ...
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="video" class="col-sm-12 col-form-label">Url Video</label>
                                        <div class="col-lg-10">
                                        <textarea type="text" class="form-control ckeditor" id="ckeditor" name="video" rows="5" required><?= $detail['video']?></textarea>
                                            <?= form_error('video', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                   </div> 
                                   <div class="form-group row mt-2 ml-3">
                                       <label for="rangkuman" class="col-sm-12 col-form-label" required>Rangkuman</label>
                                        <div class="col-lg-10">
                                        <textarea type="text" class="form-control ckeditor" id="ckeditor3" name="rangkuman" rows="25"><?= $detail['rangkuman']?></textarea>
