        ...
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb p-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class=" breadcrumb-item"><span>Create Kategori</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
          ...
          <!-- end -->
            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Mejapintar | Create Kategori</h5>
                            <div class="card-body p-0">
                                   
                                   <form method="post" action="<?= base_url('admin/create_kategori'); ?>">
